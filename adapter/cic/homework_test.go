	...
	expected := []*resource.Homework{
		{
			...
			SubmittedCount:    NewInt(11),
			NotSubmittedCount: NewInt(41),
			SeenCount:         NewInt(11),
			MarkedCount:       NewInt(0),
		...
		},
		{
			...
			SubmittedCount:    NewInt(49),
			NotSubmittedCount: NewInt(3),
			SeenCount:         NewInt(0),
			MarkedCount:       NewInt(49),
			...
			Submissions: []*resource.Submission{
				{
					Owner:     &resource.User{Id: "2013011187"},
					...
					MarkedBy:          &resource.User{Name: "汤娇"},
					MarkedAt:          "2014-10-23T23:12:39+0800",
					Mark:              Int2Pfloat32(11),
		...
		},
		{
			...
			SubmittedCount:    NewInt(51),
			NotSubmittedCount: NewInt(1),
			SeenCount:         NewInt(0),
			MarkedCount:       NewInt(51),
			Title:             "第二次作业——SCI",
		...
		},
		{
			...
			SubmittedCount:    NewInt(50),
			NotSubmittedCount: NewInt(2),
			SeenCount:         NewInt(0),
			MarkedCount:       NewInt(50),
			Title:             "综合检索报告提交专用",
			Body:              "",
			Attachment:        nil,
			Submissions: []*resource.Submission{
				{
					...
					MarkedBy:          &resource.User{Name: "王媛"},
					MarkedAt:          "2015-02-01T22:16:25+0800",
					Mark:              Int2Pfloat32(38),
					Comment:           "",
					CommentAttachment: nil,
				},
			},
